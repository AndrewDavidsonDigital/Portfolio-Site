...
<template>
  <section class="flex flex-col items-center w-[95dvw] py-2 md:w-fit md:max-w-[60rem] mx-auto overflow-hidden [&>pre>code]:whitespace-pre-wrap [&>pre>code]:rounded-lg [&>pre]:w-[inherit]">
